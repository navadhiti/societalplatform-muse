            ...
            <Grid item xs={12} sm={12} md={4} lg={4} spacing={0}>
              ...
              >
                <FormControl sx={{ m: 1, minWidth: 120 }} size="small">
                  <InputLabel id="demo-select-small" sx={{color:"#000",fontWeight:"600"}}>2022</InputLabel>
                  <Select
                    ...
                    sx={{ borderRadius: "25px", border: "2px solid black" ,color:'#000'}}
                  >
                    <MenuItem value="">
                      <em>None</em>
                    </MenuItem>
                ...
                <FormControl
                  ...
                  size="small"
                >
                  <InputLabel id="demo-select-small" sx={{color:"#000",fontWeight:"600"}}>SECTOR</InputLabel>
                  <Select
                    labelId="demo-select-small"
                    id="demo-select-small"
                    value={age}
                ...
                <FormControl sx={{ m: 1, minWidth: 120 }} size="small">
                  <InputLabel id="demo-select-small" sx={{color:"#000",fontWeight:"600"}}>VALUES</InputLabel>
                  <Select
                    labelId="demo-select-small"
                    id="demo-select-small"
                    value={age}
